//
// Created by jongs on 11/8/2021.
//

#ifndef INC_341_PROJECT_3_MQUEUE_H
#define INC_341_PROJECT_3_MQUEUE_H
...
private:
     ...
     ******************************************/
     void destroyTree(Node *aNode);
     void preOrder(Node* aNode) const;
     void copyTree(Node* sourceNode, Node*& copyNode);
     Node* merge(Node*& p1, Node*& p2);
};


#endif //INC_341_PROJECT_3_MQUEUE_H
